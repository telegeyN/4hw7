...
class SwiftViewController: UIViewController, TransferValidationProtocol {
    
    private let transfersLabel = MakerView().makerLabel(text: "International Transfers", font: Fonts.semiBold.size(20), textColor: .init(hex: "00214E"))
