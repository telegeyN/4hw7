//
//  ElcartToElcartViewController.swift
//  4hw7
//
...
class ElcartToElcartViewController: UIViewController, TransferValidationProtocol {
    
    private let transfersLabel = MakerView().makerLabel(text: "Transfers from Elcart To Elcart", font: Fonts.semiBold.size(20), textColor: .init(hex: "00214E"))
    ...
    private let cardNameLabel = MakerView().makerLabel(text: "Elcart card", font: Fonts.regular.size(13), textColor: .init(hex: "00214E"))
    private let cardNumberLabel = MakerView().makerLabel(text: "xxxx 4944", font: Fonts.extraLight.size(11), textColor: .darkGray)
    private let sum: Float = 8432.89
    private let ammountLabel = MakerView().makerLabel(text: "8432.89 KGS", font: Fonts.extraLight.size(13), textColor: .darkGray)
